...
var handlers = {
    ...
    'GetStageIntent': function() {
        ...
        var apiRule = { "サーモンラン": "coop", "レギュラーマッチ": "regular", "ガチマッチ": "gachi", "リーグマッチ": "league" };
        var apiTiming = { "今": "now", "次": "next" };
                ...
                res.on('end', () => {
                    ...
                    if (flag) {
                        if (timing == "今") {
                            ...
                            var start_time = { "month": start.getMonth() + 1, "date": start.getDate(), "hour": start.getHours() };
                            var end_time = { "month": end.getMonth() + 1, "date": end.getDate(), "hour": end.getHours() };
                        ...
                        var cardImage = { 'smallImageUrl': salmonResult.stage.image, 'largeImageUrl': salmonResult.stage.image };
...
function getButtleDuration(targetVal, nowVal, checkVal) {
    ...
    var targetTime = { "month": targetDate.getMonth() + 1, "date": targetDate.getDate(), "hour": targetDate.getHours() };
    // 開始までか、終了までか。
    if (checkVal == 'start') {
